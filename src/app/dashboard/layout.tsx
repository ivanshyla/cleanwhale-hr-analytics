...
const navigation = [
  ...
  { name: 'Управление по стране', href: '/dashboard/country', icon: Building2, roles: ['ADMIN', 'COUNTRY_MANAGER'] },
  { name: 'Графики работы', href: '/dashboard/manager-schedules', icon: Calendar, roles: ['ADMIN', 'COUNTRY_MANAGER'] },
  { name: 'Аналитика по стране', href: '/dashboard/country-analytics', icon: BarChart3, roles: ['ADMIN', 'COUNTRY_MANAGER'] },
